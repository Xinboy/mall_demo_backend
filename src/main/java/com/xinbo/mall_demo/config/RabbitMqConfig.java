...
public class RabbitMqConfig {
    ...
    public Queue orderQueue() {
        return new Queue(QueueEnum.QUEUE_ORDER_CANCEL.getExchange());
    }
     ...
     */
    @Bean
    Binding orderBingding(DirectExchange orderDirect, Queue orderQueue) {
     ...
     */
    @Bean
    Binding orderTitleBinding(DirectExchange orderTtlDirect, Queue orderTtlQueue) {
        return BindingBuilder
                .bind(orderTtlQueue)
                .to(orderTtlDirect)
